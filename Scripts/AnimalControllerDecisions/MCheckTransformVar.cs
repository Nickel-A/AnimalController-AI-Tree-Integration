...
namespace Malbers.Integration.AITree
{
    ...
    [NodeContent("Check Transform Var", "Animal Controller/Check Transform Var", IconPath = "Icons/AIDecision_Icon.png")]
    public class MCheckTransformVar : ConditionDecorator
    {
        [Header("Node")]
