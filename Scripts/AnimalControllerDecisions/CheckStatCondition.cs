...
[NodeContent("CheckStatCondition", "Custom/CheckStatCondition")]
public class CheckStatCondition : ConditionDecorator
{
...
[CustomEditor(typeof(CheckStatCondition))]
[CanEditMultipleObjects]
public class CheckStatConditionEditor : Editor
{
    public static GUIStyle StyleBlue => MTools.Style(new Color(0, 0.5f, 1f, 0.3f));

    SerializedProperty
        nodeName, inverseCondition, waitUntilTrue, checkOn, Stat, Option, StatIs, Value, TryGetValue;
    ...
    private void OnEnable()
    {
        ...
        inverseCondition = serializedObject.FindProperty("inverseCondition");
        waitUntilTrue = serializedObject.FindProperty("waitUntilTrue");
    ...
    public override void OnInspectorGUI()
    {
        ...
        EditorGUILayout.PropertyField(inverseCondition);
        EditorGUILayout.PropertyField(waitUntilTrue);
