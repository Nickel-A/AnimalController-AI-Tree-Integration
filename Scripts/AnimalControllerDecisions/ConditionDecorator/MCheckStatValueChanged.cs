...
{
    [NodeContent("Check Stat Value Changed", "Animal Controller/MConditionDecorator/Check Stat Value Changed", IconPath = "Icons/AIDecision_Icon.png")]
    public class MCheckStatValueChanged : MConditionDecorator
    {
        [Header("Node")]
        ...
        private bool CheckStat(Stat stat, AIBrain AIBrain)
        {
            ...
            bool valueChanged = !Mathf.Approximately(stat.Value, previousValue);
