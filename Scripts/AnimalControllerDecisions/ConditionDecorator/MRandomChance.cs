...
{
    [NodeContent("Random Chance", "Animal Controller/MConditionDecorator/Random Chance", IconPath = "Icons/AIDecision_Icon.png")]
    public class MRandomChance : MConditionDecorator
    {
        [Title("Decorator")]
