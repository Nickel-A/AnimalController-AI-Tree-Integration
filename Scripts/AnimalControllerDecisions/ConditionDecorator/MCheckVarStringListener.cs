...
{
    [NodeContent("Check Var String Listener", "Animal Controller/MConditionDecorator/Check Var String Listener", IconPath = "Icons/AIDecision_Icon.png")]
    public class MCheckVarStringListener : MConditionDecorator
    {
        [Header("Node")]
        ...
        List<MonoBehaviour> componentsList = new List<MonoBehaviour>();
